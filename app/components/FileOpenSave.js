...
export default class FileOpenSave extends Component {
  ...
  open () {
    ...
    dialog.showOpenDialog({properties: ['openFile'],
      ...
      this.openSelectedFile(fileNames[0])
    })
  }
  ...
  handleClick(e) {
    ...
    switch(e.target.name) {
      ...
      case "open":
        ...
        break;
      default:
        console.log("Did not recognize which click handler to call.  Got: ", e.target.name)
    }
    // this.save();
      ...
      <div className="columns">
        ...
        <div className="column">
          <div className="doc">
            ...
            <br /><br />
            <button onClick={this.handleClick} className="button is-primary" name="open">Open File</button> 
            <button onClick={this.handleClick} className="button is-link" name="save">Save File</button>
            <br />
            <br />
          </div>
          <div>
